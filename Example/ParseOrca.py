...
class ParseOrca:
    ...
    def get_optimized_coords(self) -> np.ndarray:
    ...
    def get_frequencies(self) -> list:
        ...
        If the log file doesn't contain a frequency section, return an empty list.
    ...
    def generate_report(self, out_dir, dict_key) -> None:
